...
from pynetdicom.sop_class import Verification, CTImageStorage, UltrasoundMultiFrameImageStorage, UltrasoundImageStorage
...
def handle_store(event):
    ...
    dicomHandle = DicomMetadataHandler(dataset)
...
ae.start_server(("0.0.0.0", 11113), ae_title='STORE_SCP', evt_handlers=handlers)
